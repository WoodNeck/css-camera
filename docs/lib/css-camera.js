...
(function (global, factory) {
  ...
  (global = global || self, global.CSSCamera = factory(global.glMatrix));
  ...
  var Transform = function () {
    ...
    __proto.translate = function (x, y, z) {
      ...
      glMatrix.quat.invert(rotQuat, rotQuat);
      glMatrix.vec3.transformQuat(transVec, transVec, rotQuat);
      glMatrix.vec3.add(this._position, this._position, transVec);
    };
  ...
  function getTransformMatrix(elStyle) {
    ...
    var matrix = glMatrix.mat4.fromValues.apply(glMatrix.mat4, matrixVal);
    return matrix;
  }
  ...
  var Camera = function () {
    ...
    __proto.getFocusMatrix = function (element, worldMatrix) {
      ...
      var matrix = glMatrix.mat4.fromValues.apply(glMatrix.mat4, worldMatrix);
      elStyles.forEach(function (style) {
        matrix = glMatrix.mat4.mul(matrix, matrix, getTransformMatrix(style));
      });
      return matrix;
    };
